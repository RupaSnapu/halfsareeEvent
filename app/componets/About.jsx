      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-10">
          {[
            ...
            <div
              key={i}
              className="bg-green-50 p-4 md:p-8 rounded-xl shadow-xl fade-in-card transform transition-transform hover:scale-105 hover:shadow-2xl duration-500 ease-in-out"
            >
        ...
        <div className="mt-12 md:mt-16 text-center fade-in-title delay-400">
          <p className="text-gray-800 text-sm md:text-lg">
            ...
            <a
              href="#Contact"
              className="text-green-600 font-semibold hover:underline transition duration-300 ml-1"
            >
              Get in touch today
            </a>{" "}
