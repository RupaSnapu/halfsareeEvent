...
export default function WhyWeExcel() {
  return (
    <section className="bg-gradient-to-b from-white to-green-50 mt-[-50px] py-20 px-2 sm:px-15 lg:px-20 overflow-hidden relative">
      <div className="text-center mt-[-40px] mb-12 max-w-4xl mx-auto">
        <h2 className="text-2xl sm:text-3xl font-extrabold text-green-700 mb-4 leading-tight">
         Why We Excel in Half Saree Photography
        </h2>
        <p className="text-gray-700 text-base sm:text-lg flex items-center justify-center gap-2">
      ...
      <div className="text-center mt-14">
        <a
          href="/#contact"
          className="inline-block bg-green-600 hover:bg-green-700 text-white font-semibold py-3 px-6 rounded-lg transition duration-300 shadow-md"
        >
...
function AnimatedFeature({ feature }) {
  return (
      ...
      className="min-w-[240px] sm:min-w-[180px] lg:min-w-[340px] bg-white rounded-xl shadow-md p-4 sm:p-5 flex flex-col gap-2 sm:gap-3 hover:shadow-xl transition duration-300"
    >
      <motion.div
