...
export default function Contact() {
  return (
    <>
      {/* Contact Section */}
      <section id="Contact" className="py-12 md:py-16 bg-indigo-50">
                  ...
                  return (
                    <div
                      ...
                      className={`flex gap-4 transition-transform transform hover:scale-105 duration-300 ${
                        isFirst
                          ? "bg-indigo-100 border-l-4 border-indigo-500 rounded-lg p-4 md:p-6"
                    ...
                    >
                      ...
                      <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-indigo-100 flex items-center justify-center">
                        <span className="text-indigo-700 font-bold text-sm md:text-base">
                          {index + 1}
                        </span>
                      </div>
                      {/* Step Content */}
                      <div>
                        ...
                        {isFirst && (
                          <span className="inline-block bg-indigo-200 text-indigo-800 text-[10px] md:text-xs font-semibold px-2 py-1 rounded-full mt-1">
                            Start Here
                          </span>
                        )}
            ...
            <div className="bg-white rounded-lg shadow-xl p-6 md:p-8">
              ...
              <form className="space-y-4 md:space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                  <div>
                    ...
                    <input
                      type="text"
                      id="name"
                      className="w-full px-3 py-2 md:px-4 md:py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 text-sm md:text-base"
                      required
                    />
                  </div>
                  <div>
                ...
                <div>
                  <button
                    type="submit"
                    className="bg-indigo-600 text-white font-bold text-sm md:text-base py-2 px-4 md:py-3 md:px-6 rounded-lg hover:bg-indigo-700 transition duration-300 w-full md:w-auto"
                  >
                    Send Message
                  </button>
                </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            ...
            <div className="bg-white p-6 md:p-8 rounded-lg shadow-md text-center">
              <div className="bg-indigo-100 w-14 h-14 md:w-16 md:h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg
              ...
              <p className="text-sm md:text-base text-gray-600">+44 123 456 7890</p>
              <p className="text-sm md:text-base text-gray-600">Mon-Fri: 9am-6pm</p>
            </div>
            ...
            <div className="bg-white p-6 md:p-8 rounded-lg shadow-md text-center">
              ...
              <p className="text-sm md:text-base text-gray-600">London, UK</p>
              <p className="text-sm md:text-base text-gray-600">
                By appointment only
              </p>
            </div>
