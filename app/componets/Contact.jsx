...
// //   return (
// //     <section id="Contact" className="py-12 md:py-16 bg-red-50 relative overflow-hidden">
// //       <AnimatePresence>
// //         {showFlash && (
// //           <motion.div
// //             initial={{ opacity: 0 }}
...
// //           <h1 className="text-2xl sm:text-3xl lg:text-4xl 2xl:text-5xl font-extrabold text-black mb-4">Contact Our Half-Saree Photographers</h1>
...
// //               className="bg-white rounded-lg shadow-xl p-6 md:p-8 relative overflow-hidden min-h-[400px] flex items-center justify-center"
// //             >
...
// //                         className="w-8 h-8 bg-green-100 p-1.5 rounded-full shadow-lg"
// //                         fill="currentColor"
// //                         viewBox="0 0 24 24">
...
// //                           className="w-full px-3 py-2 border border-gray-300 rounded-lg text-xs focus:ring-green-500 focus:outline-none"
// //                           {...props}
// //                         />
// //                       </div>
// //                     ))}
...
// //                       type="submit"
// //                       disabled={loading}
// //                       className={`w-full bg-green-600 text-white font-bold py-2 px-6 rounded-lg transition ${
...
// //                     >
// //                       <svg className="w-20 h-20 text-green-600 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
// //                         <motion.path
...
// //             <section className="bg-white mt-3 py-4 px-4">
// //               <div className="bg-green-50 rounded-lg p-6 text-center">
// //                 <h3 className="text-xl text-black sm:text-2xl font-semibold mb-3">Prefer Direct Contact?</h3>
// //                 <p className="mb-6 text-sm text-gray-700">
// //                   We're always available for a friendly chat-reach out anytime, day or night!
// //                 </p>

// //                 <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
// //                   <Link href="https://wa.me/447933223422" target="_blank" className="inline-flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white font-semibold py-2 px-4 rounded-lg transition">
// //                     <FaWhatsapp className="text-lg" />
// //                     WhatsApp Us
// //                   </Link>
// //                   <Link href="tel:+447933223422" className="inline-flex items-center gap-2 bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded-lg transition">
...
// //             index === 0
// //               ? "bg-green-100 border-l-4 border-green-500 rounded-lg p-4"
...
// //               className="inline-flex items-center gap-1 bg-green-200 text-green-800 text-[10px] font-semibold px-2 py-0.5 rounded-full mt-1"
// //             >
...
// //     <h2 className=" mt-5 font-bold text-black text-center">Another way to Contact</h2>
// //   <div className="flex justify-center gap-3 mt-5">
// //     <Link href="https://instagram.com" target="_blank" className="flex items-center gap-2 bg-pink-500 text-white px-4 py-2 rounded-lg text-sm hover:bg-pink-600">
// //       <FaInstagram /> Instagram
// //     </Link>
// //     <Link href="https://youtube.com" target="_blank" className="flex items-center gap-2 bg-red-600 text-white px-4 py-2 rounded-lg text-sm hover:bg-red-700">
// //       <FaYoutube /> YouTube
// //     </Link>
// //     <Link href="https://facebook.com" target="_blank" className="flex items-center gap-2 bg-blue-600 text-white px-4 py-2 rounded-lg text-sm hover:bg-blue-700">
...
//     <section
//       id="Contact"
//       className="py-12 md:py-16 bg-[#fff8f0] relative overflow-hidden font-sans"
//     >
//       <AnimatePresence>
//         {showFlash && (
//           <motion.div
...
//       <div className="container mx-auto px-4 md:px-6 relative z-10">
//         <div className="max-w-5xl mx-auto text-center mb-16">
//           <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#8b0000] mb-4 font-serif">
...
//                         className="w-8 h-8 bg-[#ffe4e1] p-1.5 rounded-full shadow-lg text-[#8b0000]"
//                         fill="currentColor"
//                         viewBox="0 0 24 24"
//                       >
//                         <path d="M17 10.5V6c0-1.1-.9-2-2-2H3C1.9 4 1 4.9 1 6v12c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2v-4.5l5 5v-13l-5 5z" />
//                       </svg>
//                       <h2 className="text-2xl md:text-3xl font-bold text-[#8b0000] font-serif">
//                         Capture Your Moment
//                       </h2>
//                     </div>
...
//                       type="submit"
//                       disabled={loading}
//                       className={`w-full bg-[#8b0000] text-white font-bold py-2 px-6 rounded-lg transition ${
//                         loading ? "opacity-50 cursor-not-allowed" : "hover:bg-[#600000]"
//                       }`}
//                       whileHover={!loading ? { scale: 1.05 } : {}}
//                       whileTap={!loading ? { scale: 0.98 } : {}}
//                     >
...
//                 <p className="mb-6 text-sm text-gray-700">
//                   We're always available for a friendly chat—reach out anytime!
//                 </p>
...
//                     target="_blank"
//                     className="inline-flex items-center gap-2 bg-[#8b0000] hover:bg-[#600000] text-white font-semibold py-2 px-4 rounded-lg transition"
//                   >
//                     <FaWhatsapp className="text-lg" />
//                     WhatsApp Us
//                   </Link>
...
//                     className="inline-flex items-center gap-2 bg-[#d4af37] hover:bg-[#bfa033] text-white font-semibold py-2 px-4 rounded-lg transition"
//                   >
//                     <FaPhoneAlt className="text-sm" />
//                     Call Us
//                   </Link>
...
//               animate={{ opacity: 1, y: 0 }}
//               transition={{ duration: 0.5 }}
//               className="text-2xl md:text-3xl font-bold text-[#8b0000] mb-4 font-serif"
//             >
//               Your Photography Journey
//             </motion.h2>
...
//                     className={`flex gap-4 ${
//                       index === 0
//                         ? "bg-[#fce8e6] border-l-4 border-[#8b0000] rounded-lg p-4"
//                         : "bg-white rounded-lg p-4 shadow-md"
//                     }`}
//                   >
...
//                           animate={{ opacity: 1, x: 0 }}
//                           transition={{ delay: 0.4, duration: 0.6 }}
//                           className="inline-flex items-center gap-1 bg-[#ffafcc] text-[#8b0000] text-[10px] font-semibold px-2 py-0.5 rounded-full mt-1"
//                         >
//                           <FaUser className="text-xs" />
//                           Start Here
//                         </motion.span>
...
//             <div className="bg-white pb-6">
//               <h2 className="mt-5 font-bold text-center text-[#8b0000] font-serif">Another Way to Contact</h2>
//               <div className="flex justify-center gap-3 mt-5">
//                 <Link
//                   href="https://instagram.com"
//                   target="_blank"
//                   className="flex items-center gap-2 bg-pink-500 text-white px-4 py-2 rounded-lg text-sm hover:bg-pink-600"
//                 >
//                   <FaInstagram /> Instagram
//                 </Link>
//                 <Link
